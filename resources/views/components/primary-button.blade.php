...
<a {{ $attributes->merge(['class' => 'inline-flex items-
    center px-4 py-2 bg-gray-800 dark:bg-gray-200 border border-
...
<button {{ $attributes->merge(['type' => 'submit',
    ...
    dark:bg-gray-200 border border-transparent rounded-md font-
    semibold text-xs text-white dark:text-gray-800 uppercase
